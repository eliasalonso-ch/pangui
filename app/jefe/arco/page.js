...
export default function JefeARCOPage() {
  ...
  useEffect(() => {
    async function load() {
      ...
      if (perfil?.rol !== "jefe") { router.push("/jefe"); return; }
    ...
    <main className={styles.page}>
      ...
      <div className={styles.infoBox}>
        <p className={styles.infoText}>
          Según la Ley 21.719, las solicitudes deben responderse en un plazo máximo de 10 días hábiles.
          Responde directamente al email del solicitante.
        </p>
      </div>
    </main>
  );
