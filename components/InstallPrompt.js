...
const DISMISSED_KEY = "pangui_install_dismissed";
  ...
  return (
    <div className={styles.banner}>
      ...
      <div className={styles.body}>
        {platform === "ios" && (
          <>
            <div className={styles.title}>Instala Pangui en tu iPhone</div>
        ...
        {platform === "android" && (
          <>
            <div className={styles.title}>
              Instala Pangui para acceso rápido
            </div>
          </>
        )}
        {platform === "desktop" && (
          <>
            <div className={styles.title}>Instala Pangui en tu escritorio</div>
            {!deferredPrompt && (
              <div className={styles.hint}>
                Menú <strong>⋮</strong> → <strong>Instalar Pangui…</strong>
              </div>
            )}
          </>
        )}
      ...
      <div className={styles.actions}>
        {platform === "ios" ? (
          ...
          <>
            ...
            <button className={styles.btnPrimary} onClick={install}>
              Instalar
            </button>
          </>
        ) : (
