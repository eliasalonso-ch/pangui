...
export const SidebarInset = ({ children }: { children: React.ReactNode }) => (
  ...
  // The page canvas. --surface-canvas rather than --surface-1 so cards (which
  // are --surface-1) keep a visible edge against it in both themes.
  <main className="flex flex-col flex-1 min-w-0 h-screen overflow-hidden" style={{ background: "var(--surface-canvas)" }}>{children}</main>
)
