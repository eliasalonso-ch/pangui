...
//
// MAINTAINER NOTE: this file is mirrored from lib/excel-export-shared.ts.
// The Deno copy needs .ts import extensions which break Next.js. When you
// change either copy, sync both.
//
