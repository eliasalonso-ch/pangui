...
export async function exportarPDF(ordenes, filtros = {}) {
  ...
  autoTable(doc, {
    startY: 24,
    head: [["Fecha", "Hora", "Tipo", "Técnico", "Ubicación", "Descripción", "Materiales", "Duración", "Estado", "Firmado por"]],
    body: tableData,
    ...
    columnStyles: {
      0: { cellWidth: 15 }, 1: { cellWidth: 11 }, 2: { cellWidth: 17 },
      3: { cellWidth: 24 }, 4: { cellWidth: 26 }, 5: { cellWidth: 44 },
      6: { cellWidth: 32 }, 7: { cellWidth: 14 }, 8: { cellWidth: 18 },
      9: { cellWidth: 22 },
    },
    didParseCell: (data) => {
