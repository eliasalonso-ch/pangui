...
const TIERS = {
  basic: {
    ...
    features: {
      ...
      preventivos: false, inventario: false, planes_mantencion: false,
      analytics_pro: false, scheduler: false,
      push: true, ai_scan: false, automatizaciones: false,
    },
  },
  esencial: {
    limits: {
    ...
    features: {
      ...
      preventivos: true, inventario: false, planes_mantencion: false,
      analytics_pro: false, scheduler: false,
      push: true, ai_scan: false, automatizaciones: false,
    },
  },
  pro: {
    ...
    features: {
      exports: true, procedimiento_auto_attach: true,
      qr_codes: true, jerarquias_activos: true,
      preventivos: true, inventario: true, planes_mantencion: true,
      analytics_pro: true, scheduler: true,
      push: true, ai_scan: true, automatizaciones: false,
    },
  },
  enterprise: {
    limits: {
    ...
    features: {
      ...
      preventivos: true, inventario: true, planes_mantencion: true,
      analytics_pro: true, scheduler: true,
      push: true, ai_scan: true, automatizaciones: true,
    },
  },
};
